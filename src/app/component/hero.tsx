...
/>  
      ...
      <div className='w-[250px] h-[2px] bg-blue-700'>
...
With a strong foundation in web development</p>
      ...
      <div className='flex justify-center'>
        <Link href={"#Contact"}>
        <button className="inline-flex text-white bg-pink-600 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded text-lg">
          Contact me
        </button>
        </Link>
      </div>
